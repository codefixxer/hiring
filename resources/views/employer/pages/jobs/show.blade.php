...
<div class="container my-4">
  <div class="card shadow-sm">
    ...
    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
      <h4 class="mb-0"><i class="bi bi-eye-fill me-2"></i>View Application</h4>
    ...
    <div class="card-body">
      ...
      <div class="row mb-4">
        <div class="col-md-6">
          <ul class="list-group list-group-flush">
            <li class="list-group-item"><strong>Job:</strong> {{ $application->job->job_title }}</li>
            <li class="list-group-item"><strong>Applicant:</strong> {{ $application->applicant->name }}</li>
            <li class="list-group-item"><strong>Applied On:</strong> {{ $application->created_at->format('Y-m-d') }}</li>
          </ul>
        </div>
        <div class="col-md-6">
          <ul class="list-group list-group-flush">
      ...
      {{-- Cover Letter --}}
      <div class="mb-4">
        <h5 class="mb-2"><i class="bi bi-file-earmark-text-fill me-1"></i>Cover Letter</h5>
      ...
      <div class="mb-4">
        <h5 class="mb-2"><i class="bi bi-lightbulb-fill me-1"></i>Job Skills</h5>
